...
public class BGMountainsMapProvider extends XYTileSource {
    public BGMountainsMapProvider() {
        super("BGMountainsMapProvider", 0, 18, 256, null, new String[]{
                "http://bgmtile.uni-plovdiv.net:40158/{z}/{x}/{y}.png"
        });
    }
